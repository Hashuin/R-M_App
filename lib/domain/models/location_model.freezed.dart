...
class _$LocationImpl implements _Location {
  const _$LocationImpl({required this.name, this.type, this.dimension});
  ...
  @override
  String toString() {
    return 'Location(name: $name, type: $type, dimension: $dimension)';
  }
...
abstract class _Location implements Location {
  const factory _Location(
      ...
      final String? type,
      final String? dimension}) = _$LocationImpl;
